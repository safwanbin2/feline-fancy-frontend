      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            <Cat size={24} className="text-cat-neon mr-2" />
            <span className="font-medium text-lg text-foreground">Feline Fancy</span>
          </div>
          
          <div className="text-muted-foreground text-sm flex items-center gap-1">
            Made with <Heart size={16} className="text-red-500 fill-red-500" /> using <a href="https://thecatapi.com" target="_blank" rel="noopener noreferrer" className="text-cat-neon hover:underline">The Cat API</a>
          </div>
